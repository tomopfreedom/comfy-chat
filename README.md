...
- **プロンプト確認パネル** — 生成前に LLM が作成した positive / negative タグを編集できる。タグ解説チップで各タグの日本語説明を確認可能
...
| `POST` | `/api/explain-tags` | positive タグを LLM で日本語解説、確認パネルのタグチップ用 |
